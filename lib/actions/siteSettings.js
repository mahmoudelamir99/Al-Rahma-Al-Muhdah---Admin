...
export async function getSiteSettings() {
  ...
  try {
    const { data, error } = await supabase
      .from(SETTINGS_TABLE)
      .select("whatsapp_enabled, map_enabled, terms_text, hero_title, hero_subtitle, hero_video_url, about_text, contact_phones, contact_email, contact_address, social_links, features_enabled, feature_1_title, feature_1_text, feature_2_title, feature_2_text, feature_3_title, feature_3_text, updated_at, updated_by")
      .eq("id", 1)
      .maybeSingle();
...
export async function updateSiteSettings({ whatsappEnabled, mapEnabled, termsText, heroTitle, heroSubtitle, heroVideoUrl, aboutText, contactPhones, contactEmail, contactAddress, socialLinks, featuresEnabled, feature1Title, feature1Text, feature2Title, feature2Text, feature3Title, feature3Text } = {}) {
  ...
  if (typeof featuresEnabled === "boolean") updates.features_enabled = featuresEnabled;
  if (typeof termsText === "string") updates.terms_text = termsText.trim().slice(0, 20000) || null;
  const textFields = { hero_title: heroTitle, hero_subtitle: heroSubtitle, hero_video_url: heroVideoUrl, about_text: aboutText, contact_phones: contactPhones, contact_email: contactEmail, contact_address: contactAddress, feature_1_title: feature1Title, feature_1_text: feature1Text, feature_2_title: feature2Title, feature_2_text: feature2Text, feature_3_title: feature3Title, feature_3_text: feature3Text };
